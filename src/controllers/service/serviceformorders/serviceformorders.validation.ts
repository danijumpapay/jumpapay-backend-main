...
export const findAllServiceFormOrdersSchema = Joi.object({
...
export const serviceFormOrderIdSchema = Joi.object({
  id: Joi.number().integer().required().label("Service ID"),
});

export const createOrUpdateServiceFormOrderSchema = Joi.object({
