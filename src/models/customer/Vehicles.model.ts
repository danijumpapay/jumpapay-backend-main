...
import StnkDocuments from './StnkDocuments.model';
import BpkbDocuments from './BpkbDocuments.model';
...
class Vehicles extends Model {
  ...
  static relationMappings = {
    ...
    stnkDocuments: {
        ...
        modelClass: StnkDocuments,
        join: {
            from: 'customer.vehicles.id',
            to: 'customer.stnk_documents.vehicle_id'
        }
    },
    bpkbDocuments: {
        relation: Model.HasManyRelation,
        modelClass: BpkbDocuments,
        join: {
            from: 'customer.vehicles.id',
            to: 'customer.bpkb_documents.vehicle_id'
        }
    },
    images: {
        relation: Model.HasManyRelation,
        modelClass: VehicleImages,
        join: {
            from: 'customer.vehicles.id',
            to: 'customer.vehicle_images.vehicle_id'
        }
    }
  };
}
